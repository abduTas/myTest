...
public class CopyOfBasicCourseTestNG {
	...
	public void boxColorChange() throws InterruptedException{
		...
		String color2 = (String) js.executeScript("return document.querySelector('#main').contentWindow.document.querySelector('#child')" +
				".contentWindow.document.querySelector('#answer').className;");
		while(!color1.equals(color2))
		{
			...
			Thread.sleep(1000);
			color2=(String)js.executeScript("return document.querySelector('#main').contentWindow.document.querySelector('#child')" +
					".contentWindow.document.getElementById('answer').getAttribute('class');");
		}		
