...
public  class BingApi {
    ...
    private static String referrer="Mozila/5.0";
    public static URL url = new URL("http://api.microsofttranslator.com/");
    private static String clientId= "abdulla";
    private static String clientSecret="ULmCt0a5kjI0kmaedKpZ8r07hYTbFqpRbjV74qFTWTQ=";
...
//    }
     ...
     */
    public String getToken(final String clientId, final String clientSecret) throws Exception {
    ...
    private  String retrieveResponse(final URL url) throws Exception {
        if(clientId!=null&&clientSecret!=null&&System.currentTimeMillis()>tokenExpiration) {
           ...
           org.json.JSONObject json = new org.json.JSONObject(tokenJson);
...
//        final JSONArray jsonArr = (JSONArray)JSONValue.parse(inputString);
//        String[] values = new StriExceptionng[jsonArr.size()];
//        
//        int i = 0;
//        for(Object obj : jsonArr) {
...
public static void main(String[] args) throws Exception {
	BingApi ms = new BingApi();
	ms.getToken(clientId, clientSecret);
	ms.retrieveResponse(url);
